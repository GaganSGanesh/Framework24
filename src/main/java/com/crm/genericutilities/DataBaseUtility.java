...
public class DataBaseUtility {
	...
	con=DriverManager.getConnection(fui.getPropertyKeyValue("dburl"),fui.getPropertyKeyValue("dbusername"),fui.getPropertyKeyValue("dbpassword"));/*fui is fileutility created above*/
           }catch (Exception e) {
			e.printStackTrace();
		}
    }
